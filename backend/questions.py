...
QUESTIONS.extend([
    ...
    Question("q_romantic_fugitive", "Is the plot driven by a couple on the run from society/family?",
             _attr_eq("has_romantic_fugitive", True), weight=1.2),
    Question("q_lookalike_twin", "Does the protagonist use a lookalike or twin for deception?",
             _attr_eq("has_lookalike_twin_deception", True), weight=1.2),
    Question("q_cop_protagonist", "Is the protagonist a cop or law enforcement officer?",
             _attr_eq("has_cop_protagonist", True), weight=1.2),
    Question("q_frontier_western", "Does the film have Western/frontier/cowboy elements?",
             _attr_eq("has_frontier_elements", True), weight=1.1),
    Question("q_neighborhood_brotherhood", "Is it about neighborhood friendship or street brotherhood?",
             _attr_eq("has_neighborhood_brotherhood", True), weight=1.1),
    Question("q_faction_feud", "Is it driven by multi-generational family blood feuds or land oppression?",
             _attr_eq("has_faction_feud", True), weight=1.2),
    Question("q_divine_intervention", "Does it feature divine/magical/mythological elements?",
