...
QUESTIONS.extend([
    ...
    Question("q_home_turf_vigilance",   "Is it about domestic financial/political clean-up within India (not international espionage)?",
             _attr_true("has_home_turf_vigilance"), weight=0.3),
